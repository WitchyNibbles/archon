...
type SaveReviewStore = Pick<PostgresStore, "findLatestRunForTask" | "saveOrchestratorReview">;
...
type ApprovalStore = Pick<
  ArchonStoreContract,
  "findLatestRunForTask" | "getTasksByRun" | "getReviews" | "saveApproval" | "updateTask"
>;
